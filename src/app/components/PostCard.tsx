...
const PostCard = ({description, banner_url, title} : {description: string, banner_url: string, title: string}) => {
  ...
  return (
    <Link className='flex flex-col h-80 w-72 shadow-lg border-2 hover:bg-[#d3dadf] hover:border-[#279ff0] hover:shadow-2xl cursor-pointer rounded-lg' href={`/blog/${title}`}>
